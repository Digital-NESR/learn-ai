...
export const metadata: Metadata = { title: 'Hackathon | NESR UpskillAI' };
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 font-sans text-slate-900">
      ...
      <main className="flex-1 w-full">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 py-16 text-center">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#f0f9f4]">
            <Rocket className="h-8 w-8 text-[#307c4c]" />
          </div>
          ...
          <h1 className="mt-5 text-4xl font-bold tracking-tight text-slate-900 leading-tight">
            The NESR AI Hackathon
          </h1>
          <p className="mt-3 text-lg text-slate-500 leading-relaxed max-w-xl mx-auto">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3 text-left">
            {HIGHLIGHTS.map(({ icon: Icon, title, body }) => (
              <div key={title} className="rounded-xl border border-gray-200 bg-white p-5">
                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#f0f9f4] text-[#307c4c]">
          ...
          <div className="mt-10">
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#307c4c] hover:underline"
            >
