...
const productivityModules: Module[] = [
  {
    id: 'productivity-1',
    partLabel: 'Part 1 of 17',
    part: 1,
    title: 'How to Use Claude Pro',
    tagline: "Most people use Claude like a search engine - here's what it actually does once you go further.",
    requirement: 'required',
    minutes: 16,
    sections: [
      {
        kind: 'lead',
        text: "If you've only ever typed a question into Claude and read the answer, you're using a fraction of what Claude Pro can do for real work.",
        body: "This video runs through a set of concrete Claude Pro features - beyond plain chat - that turn it into an assistant for email, scheduling, building quick internal tools, and organizing recurring work. The presenter's framing: using Claude like a search engine is like buying a Ferrari and only driving it in a parking lot.",
      },
      {
        kind: 'video',
        youtubeId: 'wZeOwqmSw84',
        heading: 'Watch: Learn 97% of Claude in Under 16 Minutes (~16 min)',
        caption: 'Dan Martell (~16 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          {
            title: 'Bring your history over with Memory import',
            body: 'Under Settings → Capabilities, you can import prior chat history/preferences (for example, from ChatGPT) in about two minutes, so Claude starts with useful context instead of a blank slate.',
          },
          {
            title: 'Pick the right model for the job',
            body: "Claude offers a model selector - Haiku for fast, cheap, high-volume tasks, Sonnet for everyday work, and Opus for complex reasoning - so you're not paying Opus-level cost for a Haiku-level task.",
          },
          {
            title: 'Connect Gmail for email work',
            body: 'A Gmail connector (Sidebar → Connectors → Gmail, roughly a 30-second setup) lets Claude search, summarize, and draft emails directly - the video argues this beats Gmail\'s own native search.',
          },
          {
            title: 'Connect Calendar for time analysis',
            body: 'A Google Calendar connector lets Claude help with time-blocking and analyzing how your time is actually being allocated across meetings and work.',
          },
          {
            title: 'Artifacts for quick internal tools',
            body: 'Artifacts let you build small interactive tools in-chat - calculators, trackers, even a non-technical dashboard - without hiring a developer.',
          },
          {
            title: 'Projects for recurring, grounded work',
            body: 'Projects bundle documents and context into a folder Claude can draw on repeatedly - the video\'s example links transcribed coaching calls stored in Google Drive to a Project.',
          },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What analogy does the video use to describe people who only use Claude like a search engine?',
        options: [
          'Buying a Ferrari and only driving it in a parking lot',
          'Using a smartphone as a paperweight',
          'Owning a library card you never use',
          'Driving a bicycle on a highway',
        ],
        answer: 0,
        explanation: 'The video frames underusing Claude as the equivalent of buying a Ferrari and never taking it out of the parking lot.',
      },
      {
        prompt: 'What does the Memory import feature (Settings → Capabilities) let you do?',
        options: [
          'Delete your entire chat history',
          'Import prior chat history/preferences, such as from ChatGPT, in about two minutes',
          'Transfer your Claude subscription to another account',
          'Back up your files to an external hard drive',
        ],
        answer: 1,
        explanation: 'Memory import brings existing context (like ChatGPT history) into Claude in roughly two minutes, instead of starting from zero.',
      },
      {
        prompt: 'According to the video, what is the difference between the Haiku, Sonnet, and Opus models?',
        options: [
          'They are just different visual themes for the app',
          'Haiku is fast/cheap for high-volume tasks, Sonnet handles everyday work, and Opus is for complex reasoning',
          'They are identical, just named differently by region',
          'Only Opus can be used for free',
        ],
        answer: 1,
        explanation: 'The model selector lets you match cost and speed to the task: Haiku for volume, Sonnet for daily work, Opus for the hardest reasoning.',
      },
      {
        prompt: 'What can the Gmail connector do once set up?',
        options: [
          'Search, summarize, and draft emails directly from Claude',
          'Permanently delete emails without confirmation',
          'Only display your inbox as a read-only list',
          'Send emails automatically with no human review'
        ],
        answer: 0,
        explanation: 'The Gmail connector lets Claude search, summarize, and help draft emails - the video argues its search beats Gmail\'s native search.',
      },
      {
        prompt: 'What is an Artifact used for, per the video?',
        options: [
          'Building small interactive tools - like calculators or trackers - directly in a Claude conversation',
          'Storing your billing information',
          'Automatically translating the chat into another language',
          'Scheduling calendar events only',
        ],
        answer: 0,
        explanation: 'Artifacts let you build working mini-tools inline, such as a calculator, tracker, or simple dashboard, without needing a developer.',
      },
      {
        prompt: 'What does a Claude Project bundle together, based on the video\'s example?',
        options: [
          'Nothing - Projects are purely cosmetic folders',
          'Documents and context Claude can draw on repeatedly, like coaching call transcripts linked from Google Drive',
          'Only billing and account settings',
          'A list of other Claude users to message',
        ],
        answer: 1,
        explanation: 'The video\'s example links transcribed coaching calls stored in Google Drive into a Project, so Claude has that context available across future conversations.',
      },
    ],
  },
  {
    id: 'productivity-2',
    partLabel: 'Part 2 of 17',
    part: 2,
  ...
  },
  {
    ...
    sections: [
      {
        kind: 'lead',
        text: 'If you keep re-uploading the same files or re-typing the same background every time you open a new chat, you are doing recurring work the hard way.',
        body: 'Claude Projects let you bundle instructions, reference files, and prior conversations into one persistent workspace, so Claude already knows your role, your standards, and your source material before you type a single word. For recurring work - a weekly report, a recurring client, an ongoing audit - that setup pays for itself almost immediately.',
      },
      {
        kind: 'video',
        youtubeId: 'xkjE9WFbWAY',
        heading: 'Watch: Claude Projects Tutorial: What They Are and How to Use Them (~15 min)',
        caption: 'The AI Productivity Coach (~15 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: "Plain chat memory isn't enough", body: 'A regular Claude conversation forgets everything once it ends. Projects exist specifically for work you do repeatedly, where re-explaining the same background every time wastes time and produces inconsistent results.' },
          { title: 'Three things go inside every Project', body: 'The video walks through what actually belongs in a Project setup - custom instructions describing how Claude should behave, reference files it should treat as ground truth, and the ongoing conversations tied to that context.' },
          { title: 'A common early mistake', body: 'The presenter shares a mistake made when first setting up a Project - treating it like a dumping ground for random files instead of a focused, curated workspace - and how that hurt output quality.' },
          { title: 'Projects vs. Skills vs. Artifacts', body: 'These three Claude features are easy to confuse. Projects hold persistent context and files; Skills package reusable instructions/capabilities; Artifacts are the standalone outputs (docs, code, apps) Claude generates inside a chat.' },
          { title: 'Real use cases, built live', body: 'The video demonstrates several practical use cases, including building a Project on screen for managing an ongoing YouTube channel - showing how the same Project keeps informing new chats over time.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What problem are Claude Projects mainly designed to solve?',
        options: ['Making Claude respond faster', 'Avoiding the need to re-explain context and re-upload files for recurring work', 'Reducing the cost of a Claude Pro subscription', 'Letting multiple people edit the same document at once'],
        answer: 1,
        explanation: 'Projects preserve instructions, files, and context across conversations so you stop repeating yourself for work you do again and again.',
      },
      {
        prompt: 'According to the video, what mistake did the presenter make early on with their first Project?',
        options: ['They never used a Project at all', 'They treated the Project as a dumping ground for files instead of a focused workspace', 'They deleted their Project by accident', 'They shared their Project with the wrong team'],
        answer: 1,
        explanation: 'The video specifically calls out an early mistake of overloading a Project with unfocused material rather than curating what belongs in it.',
      },
      {
        prompt: 'How does the video distinguish Claude Projects from Artifacts?',
        options: ['They are the exact same feature with different names', 'Projects hold persistent context/files; Artifacts are the standalone outputs Claude generates in a chat', 'Artifacts store your instructions while Projects generate the documents', 'Projects only work on mobile, Artifacts only work on desktop'],
        answer: 1,
        explanation: 'Projects are the persistent workspace (instructions + files); Artifacts are the docs/code/apps produced inside a conversation.',
      },
      {
        prompt: 'What does the video demonstrate as a "live build" example?',
        options: ['Building a spreadsheet macro', 'Setting up a Project for managing an ongoing YouTube channel', 'Training a custom AI model', 'Migrating a database'],
        answer: 1,
        explanation: 'The presenter builds a Claude Project on screen for an ongoing YouTube channel workflow as one of the real use cases.',
      },
      {
        prompt: 'Based on the video, which scenario is the best fit for a Claude Project rather than a one-off chat?',
        options: ['Asking a single unrelated trivia question', 'A recurring weekly report that always draws on the same background material', 'Generating one random image', 'Translating a single sentence'],
        answer: 1,
        explanation: 'Projects shine for recurring work where the same context, files, and instructions apply conversation after conversation.',
      },
    ],
  },
  {
    id: 'productivity-6',
    partLabel: 'Part 6 of 17',
    part: 6,
    ...
    sections: [
      {
        kind: 'lead',
        text: "Sometimes the answer you need isn't a paragraph - it's a working thing: a calculator, a chart, a formatted report, a small interactive tool.",
        body: "Claude's Artifacts feature spins up that kind of standalone output right inside your conversation, and lets you keep iterating on it with follow-up prompts instead of starting over. Knowing what artifacts are good for - and where they go wrong - makes them far more useful for real work.",
      },
      {
        kind: 'video',
        youtubeId: '9YGg4JaVN4w',
        heading: 'Watch: Claude Artifacts: What They Are and How to Use Them (~5 min)',
        caption: 'The AI Productivity Coach (~5 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'What an Artifact actually is', body: 'Artifacts let you build working tools, dashboards, and interactive documents inside Claude that live in their own dedicated pane, separate from the back-and-forth of the conversation.' },
          { title: 'They group into a handful of categories', body: 'The video organizes common Artifact types into a small set of "buckets" - things like documents, data visualizations/dashboards, diagrams, and interactive mini-apps - to help you recognize what to ask for.' },
          { title: 'Cool use cases', body: 'The video walks through practical, concrete examples of Artifacts in action, showing how a request phrased the right way turns into a usable, shareable output rather than just more chat text.' },
          { title: 'Common mistakes to avoid', body: 'The video closes with pitfalls to watch for - vague requests that produce unfocused artifacts, and not iterating with follow-up prompts to refine what Claude already built for you.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'Where does a Claude Artifact appear relative to the conversation?',
        options: ['It replaces the chat entirely', 'In its own dedicated pane, separate from the conversation flow', 'Only as a downloadable email attachment', 'It cannot be viewed until the chat ends'],
        answer: 1,
        explanation: 'Artifacts render in a separate pane alongside the chat, keeping the substantial output distinct from the conversational back-and-forth.',
      },
      {
        prompt: 'How does the video help viewers recognize what to ask Claude for?',
        options: ['By providing exact code templates only', 'By grouping common Artifact types into a small set of categories or "buckets"', 'By requiring a paid plugin', 'By listing every possible programming language'],
        answer: 1,
        explanation: 'The video breaks artifacts into buckets like documents, dashboards/visualizations, diagrams, and interactive tools to make the feature easier to reach for.',
      },
      {
        prompt: 'What is one mistake the video warns against when using Artifacts?',
        options: ['Using Artifacts at all', 'Making requests too vague and not iterating with follow-up prompts', 'Sharing an artifact with a teammate', 'Using Artifacts for code'],
        answer: 1,
        explanation: 'The video specifically calls out vague requests and skipping iterative refinement as mistakes that lead to weak artifacts.',
      },
      {
        prompt: 'What is a practical benefit of building something as an Artifact instead of asking for a plain text answer?',
        options: ['It automatically publishes to the internet', 'You get a working, standalone output (like a tool or dashboard) you can keep refining', 'It uses less of your monthly usage quota', "It disables Claude's memory"],
        answer: 1,
        explanation: 'Artifacts produce a substantial, workable output - not just more prose - that you can iterate on with further requests.',
      },
    ],
  },
  {
    id: 'productivity-7',
    partLabel: 'Part 7 of 17',
    part: 7,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'The default Claude voice is generic on purpose - it has to work for everyone. Your team\'s work usually isn\'t generic.',
        body: "Custom Styles let you teach Claude a specific tone, structure, and level of detail - concise for a quick internal update, formal for client-facing writing, or matched to your own writing sample - so you stop re-prompting for the same voice every time.",
      },
      {
        kind: 'video',
        youtubeId: 'x3RXjzOInCc',
        heading: 'Watch: How To Create Custom Writing Styles With Claude AI, Step-by-Step (~6 min)',
        caption: 'Jonathan Mast (~6 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'Styles control tone and format, not knowledge', body: "Custom Styles change how Claude responds - its voice, structure, and length - rather than what facts or capabilities it has access to." },
          { title: 'You can describe a style in plain language', body: 'Instead of writing code or complex configuration, you can just describe the tone and format you want (for example: shorter sentences, no jargon, bullet-first structure) and Claude builds a style from that description.' },
          { title: 'You can teach Claude your own voice from a writing sample', body: 'The video shows how uploading or pasting an existing piece of writing lets Claude analyze patterns - sentence length, vocabulary, structure - and turn that into a reusable style matching your unique tone.' },
          { title: 'It solves a real repetition problem', body: "Anyone who has re-typed 'keep it short' or 'make this sound more formal' in every single chat is the target audience - a saved style removes that repeated correction step." },
        ],
      },
    ],
    quiz: [
      {
        prompt: "What do Custom Styles primarily change about Claude's responses?",
        options: ["Claude's factual knowledge", 'The tone, structure, and format of the output', 'The subscription price', 'Which model version answers you'],
        answer: 1,
        explanation: "Styles reshape how Claude communicates - tone, sentence structure, formatting - not what it knows.",
      },
      {
        prompt: 'According to the video, how can you create a style without writing any code?',
        options: ['You cannot - styles require a developer', 'By describing the tone/format you want in plain language, or by giving Claude a writing sample', 'By editing a hidden settings file manually', 'By purchasing a separate add-on'],
        answer: 1,
        explanation: 'The video shows describing the desired style in plain language, or supplying a writing sample for Claude to analyze and match.',
      },
      {
        prompt: 'What repeated annoyance is a custom style meant to eliminate?',
        options: ['Having to log in every session', 'Manually re-typing tone/format corrections (like "make this shorter") in every conversation', 'Claude forgetting the entire conversation history', 'Slow response times'],
        answer: 1,
        explanation: 'A saved style bakes in your preferred tone and format so you stop repeating the same correction every chat.',
      },
      {
        prompt: 'How does Claude learn "your unique tone" from an existing writing sample, per the video?',
        options: ['It ignores the sample and uses a generic template', 'It analyzes patterns in the sample, like sentence length and structure, to build a matching style', 'It requires you to manually label every sentence', 'It only works with poetry'],
        answer: 1,
        explanation: 'The video demonstrates supplying a writing sample so Claude can extract tone/structure patterns and turn them into a style.',
      },
    ],
  },
  {
    id: 'productivity-8',
    partLabel: 'Part 8 of 17',
    part: 8,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Long PDFs, dense reports, and stacks of source material are exactly the kind of work Claude is built to accelerate.',
        body: "Beyond simple summarization, Claude can be set up as a genuine research assistant - pulling out key findings, comparing sources, and helping structure the output - as long as you know which features to reach for and how to prompt them for research-grade work.",
      },
      {
        kind: 'video',
        youtubeId: 'bANtRh9qIWM',
        heading: 'Watch: Master Claude for Researchers, Step-by-Step Tutorial (~15 min)',
        caption: 'WiseUp Communications (~15 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'Claude covers the full research workflow', body: 'The video walks through using Claude for research work broadly - not just one task - including literature reviews, managing source material, and performing data analysis.' },
          { title: 'Connectors extend what Claude can reach', body: "The tutorial highlights Claude's Connectors as a way to pull in outside information sources rather than relying only on what you manually paste or upload." },
          { title: 'Skills package repeatable research tasks', body: "Claude Skills are shown as a way to package up recurring research steps so you aren't rebuilding the same prompt structure for every new paper or report." },
          { title: 'It is a step-by-step tutorial, not just theory', body: 'The video is structured as a hands-on walkthrough aimed at researchers, showing concrete steps rather than only describing capabilities abstractly.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: "What is the scope of this video's coverage of Claude for research?",
        options: ['Only PDF summarization', 'A broad walkthrough including literature reviews, managing data, and data analysis', 'Only citation formatting', 'Only image generation'],
        answer: 1,
        explanation: 'The video explicitly covers literature reviews, managing research data, and performing data analysis, not a single narrow task.',
      },
      {
        prompt: 'What does the video say Connectors are used for?',
        options: ['Connecting Claude to outside information sources', 'Formatting citations automatically', 'Translating documents', 'Compressing PDF file size'],
        answer: 0,
        explanation: 'Connectors are presented as a way to pull in outside sources rather than relying solely on manually pasted content.',
      },
      {
        prompt: 'How are Skills positioned in this research context?',
        options: ["As a way to package recurring research tasks so you don't rebuild the same steps each time", 'As a paid-only feature unrelated to research', 'As a replacement for reading the source documents yourself', 'As a way to delete old conversations'],
        answer: 0,
        explanation: 'Skills let you reuse a defined set of research steps instead of re-explaining the same process for every new document.',
      },
      {
        prompt: 'What best describes the format of this video?',
        options: ['An abstract discussion with no demonstrations', 'A step-by-step tutorial aimed specifically at researchers', 'A product announcement press release', 'A comedy sketch about AI'],
        answer: 1,
        explanation: 'It is built as a hands-on, step-by-step tutorial for using Claude in a research workflow.',
      },
    ],
  },
  {
    id: 'productivity-9',
    partLabel: 'Part 9 of 17',
    part: 9,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Email is where a lot of real work quietly piles up.',
        body: 'Copilot in Outlook can scan a long thread and pull out the key points and open questions, help you draft or refine a reply in your own tone, and get you ready for a meeting without re-reading everything that led up to it.',
      },
      {
        kind: 'video',
        youtubeId: 'fo8ALaLSyZQ',
        heading: 'Watch: Using Copilot in Outlook to Summarize Email Threads (~5 min)',
        caption: 'Microsoft Community Learning (~5 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'One-click thread summaries', body: 'Select Summarize (or "Summary by Copilot") at the top of a long email thread and Copilot pulls out the key points, decisions, and open questions.' },
          { title: 'Citations back to the source email', body: 'Summaries include numbered references you can click to jump straight to the original message in the thread.' },
          { title: 'Drafting help, not just reading help', body: 'Copilot can also draft or rewrite a reply based on a short instruction, so you spend less time staring at a blank message.' },
          { title: 'Useful before meetings too', body: 'Catching up on a thread with Copilot is a fast way to walk into a related meeting already knowing what was discussed and decided.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What does Copilot do when you select "Summarize" on a long email thread in Outlook?',
        options: ['It scans the thread and produces a summary of key points and open questions', 'It automatically deletes older messages in the thread', 'It forwards the thread to your manager', 'It blocks the sender'],
        answer: 0,
        explanation: 'Copilot reads through the thread and surfaces the key points, decisions, and open questions as a summary.',
      },
      {
        prompt: 'What do the numbered citations in a Copilot email summary do?',
        options: ['Nothing - they are just decorative', 'They link back to the specific original message the point came from', 'They count how many people are on the thread', 'They rank messages by importance automatically'],
        answer: 1,
        explanation: 'Clicking a citation takes you to the corresponding email in the thread so you can verify context.',
      },
      {
        prompt: 'Besides summarizing, what else can Copilot in Outlook help with?',
        options: ['Drafting or refining email replies', 'Physically printing documents', 'Booking flights', 'Compiling code'],
        answer: 0,
        explanation: 'Copilot can help draft and rewrite messages, not just summarize existing ones.',
      },
      {
        prompt: 'How can summarizing a thread with Copilot help before a meeting?',
        options: ['It automatically cancels the meeting', 'It lets you catch up on what was discussed and decided without re-reading everything', 'It changes the meeting time', 'It mutes meeting notifications'],
        answer: 1,
        explanation: 'A quick summary means you can walk into a related meeting already up to speed.',
      },
    ],
  },
  {
    id: 'productivity-10',
    partLabel: 'Part 10 of 17',
    part: 10,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Missing part of a meeting or falling behind in a busy channel used to mean a lot of scrolling.',
        body: 'Copilot in Teams can recap a meeting in progress, generate a post-meeting summary with action items, and help you catch up on chats and channels you were not able to follow in real time.',
      },
      {
        kind: 'video',
        youtubeId: '8V97xlfiVso',
        heading: 'Watch: How to Use Microsoft Teams Copilot in 2025: AI Notes & Recap (~9 min)',
        caption: 'Maksims Sics (~9 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'Recap the meeting so far', body: 'If you join late or lose focus, you can ask Copilot in the meeting side panel to recap what has been discussed and decided up to that point.' },
          { title: 'Automatic notes and highlights', body: 'During a transcribed meeting, Copilot can generate notes, highlight key moments, and flag when you were mentioned.' },
          { title: 'Post-meeting Recap tab', body: 'After the meeting ends, a Recap tab gathers the summary, action items, and tagged moments in one place for anyone to review later.' },
          { title: 'Catching up on chats too', body: 'Copilot can summarize a busy chat or channel thread, not just meetings, so you can get caught up quickly.' },
          { title: 'Transcription needs to be on', body: 'Meeting recap and note features depend on transcription being enabled for that meeting.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What can you ask Copilot to do if you join a Teams meeting late?',
        options: ['Recap what has been discussed so far in the meeting', 'Automatically reschedule the meeting', 'Remove other attendees', "Turn off everyone's camera"],
        answer: 0,
        explanation: 'Copilot can privately summarize the main topics and decisions covered before you joined.',
      },
      {
        prompt: 'Where do the meeting summary, action items, and highlights end up after a meeting?',
        options: ['They are deleted automatically', "In the meeting's Recap tab", "Only in the organizer's personal notes app", 'Printed to a PDF and emailed to IT'],
        answer: 1,
        explanation: 'The Recap tab collects the summary, action items, and tagged moments for the whole team to review.',
      },
      {
        prompt: 'What is required for Copilot to generate meeting notes and recaps?',
        options: ['Everyone must be in the same office', 'Transcription must be enabled for the meeting', 'The meeting must be under 5 minutes', 'A separate paid app must be installed'],
        answer: 1,
        explanation: "Copilot relies on the meeting transcript to produce notes, recaps, and answers.",
      },
      {
        prompt: 'Besides meetings, what else can Copilot in Teams help you catch up on?',
        options: ['Busy chats and channel conversations', 'Your personal email inbox in Gmail', 'Your calendar in a different company', 'Physical mail'],
        answer: 0,
        explanation: 'Copilot can summarize chat and channel activity, not just meetings.',
      },
    ],
  },
  {
    id: 'productivity-11',
    partLabel: 'Part 11 of 17',
    part: 11,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Sometimes the AI help you need is specific to your own team or process.',
        body: 'Copilot Studio lets you build a custom AI agent without writing code - give it instructions, connect it to your own knowledge sources, and publish it so others can use it, all through a guided, visual interface.',
      },
      {
        kind: 'video',
        youtubeId: 'dX9MJM5EokE',
        heading: 'Watch: How to Use Microsoft Copilot Studio, Step-by-Step Tutorial (~20 min)',
        caption: 'Kevin Stratvert (~20 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'No-code agent building', body: 'Copilot Studio lets you create an AI agent through a guided interface - describing what it should do rather than writing code.' },
          { title: "Instructions define the agent's behavior", body: 'You give the agent plain-language instructions that shape its tone, scope, and what it should and should not do.' },
          { title: 'Knowledge sources ground its answers', body: 'You can connect documents, sites, or other sources so the agent answers using your own content instead of general knowledge alone.' },
          { title: 'Topics handle specific tasks', body: 'Topics let you define structured conversation flows for particular questions or tasks the agent should handle in a specific way.' },
          { title: 'Test before you publish', body: 'Copilot Studio includes a test pane so you can try out the agent and refine its instructions before rolling it out.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What is the main promise of Copilot Studio for building an agent?',
        options: ['You must write custom code for every agent', 'You can build an AI agent through a guided, no-code interface', 'It only works for Microsoft employees', 'It replaces the need for any instructions at all'],
        answer: 1,
        explanation: 'Copilot Studio is designed so people can build agents by configuration and plain-language instructions, not code.',
      },
      {
        prompt: "What do instructions do for a Copilot Studio agent?",
        options: ["They shape the agent's tone, scope, and behavior", "They only control the agent's color scheme", "They set the company's IT budget", 'They are optional and never affect the agent'],
        answer: 0,
        explanation: 'Instructions are plain-language guidance that shape how the agent behaves and responds.',
      },
      {
        prompt: 'Why would you connect a knowledge source to an agent?',
        options: ['So it answers using your own documents or content instead of general knowledge alone', 'So it can send emails automatically without review', 'So it deletes files it does not need', 'It is required only for agents in other languages'],
        answer: 0,
        explanation: "Knowledge sources ground the agent's answers in your specific content rather than generic information.",
      },
      {
        prompt: 'What should you do before publishing an agent?',
        options: ['Skip testing to save time', 'Test it in the built-in test pane and refine its instructions', 'Delete all its knowledge sources', 'Immediately share it with the entire company with no review'],
        answer: 1,
        explanation: 'Copilot Studio provides a way to test and iterate on the agent before making it available to others.',
      },
    ],
  },
  {
    id: 'productivity-12',
    partLabel: 'Part 12 of 17',
    part: 12,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Some questions take more than one back-and-forth to answer well.',
        body: 'Copilot Notebooks give you a persistent workspace tied to a topic or project - you add files and sources, keep a running Copilot conversation grounded in them, and can hand off deeper, multi-step research to the Researcher agent instead of chasing it yourself across many separate chats.',
      },
      {
        kind: 'video',
        youtubeId: 'oalNUvFK_oA',
        heading: 'Watch: Copilot Notebooks Full Tutorial (~12 min)',
        caption: 'Pragmatic Works AI Academy (~12 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'A persistent workspace, not a one-off chat', body: 'A Notebook stays tied to a project or topic, holding its files, chats, and notes together instead of starting fresh each time.' },
          { title: 'Add your own sources', body: "You can add documents, files, and other references so Copilot's answers inside that Notebook stay grounded in that material." },
          { title: 'Chat and notes side by side', body: 'You can keep a Copilot conversation going while capturing your own notes or a page, without losing context or switching tools.' },
          { title: 'Researcher agent for deeper dives', body: 'For more complex, multi-step research questions, you can call on the Researcher agent from within the Notebook to do more thorough digging.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What makes a Copilot Notebook different from a single one-off Copilot chat?',
        options: ['It deletes itself after one use', 'It is a persistent workspace tied to a topic or project that keeps files, chats, and notes together', 'It only works offline', 'It can only be used once per day'],
        answer: 1,
        explanation: 'Notebooks persist across sessions and keep your material and conversation history organized around a project.',
      },
      {
        prompt: 'Why would you add your own files or documents to a Notebook?',
        options: ["To ground Copilot's answers in that specific material", 'Files cannot actually be added to Notebooks', 'To automatically publish them publicly', 'To reduce the file size of the Notebook'],
        answer: 0,
        explanation: 'Adding sources lets Copilot answer using your own content rather than general knowledge alone.',
      },
      {
        prompt: 'What is meant by "multi-turn" research in a Notebook?',
        options: ['You can only ask one question ever', 'You can ask follow-up questions that build on earlier context instead of repeating it each time', 'Every question must be answered by a different person', 'The Notebook automatically closes after one question'],
        answer: 1,
        explanation: 'Because the Notebook retains context, you can iterate with follow-up questions rather than starting over.',
      },
      {
        prompt: 'What is the Researcher agent used for within a Notebook?',
        options: ['Formatting fonts in documents', 'Handling more complex, multi-step research questions', 'Scheduling meetings', 'Sending emails on your behalf'],
        answer: 1,
        explanation: 'The Researcher agent is aimed at deeper, more involved research tasks beyond a quick answer.',
      },
    ],
  },
  {
    id: 'productivity-13',
    partLabel: 'Part 13 of 17',
    part: 13,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Everyone can already open Copilot for free in a browser or on Windows. The paid tier promises faster responses and access inside Word, Excel, and Outlook - but that does not automatically mean it is worth it for your role.',
        body: 'Before you request a Copilot Pro license, watch a hands-on, no-hype comparison of what actually changes between the free tier and the paid one, including where the paid tier still falls short.',
      },
      {
        kind: 'video',
        youtubeId: 'd5W5tRaImJA',
        heading: 'Watch: Microsoft Copilot Pro (An Honest Review) (~19 min)',
        caption: 'Matt Wolfe (~19 min)',
      },
      {
        kind: 'compare',
        heading: 'What changes when you upgrade',
        left: {
          title: 'Copilot (Free)',
          items: [
            'Available at no cost through the browser, the mobile app, and built into Windows.',
            'Runs on capable models, but Microsoft can throttle or drop you to a lower-tier model during high-demand periods.',
            'Not integrated into Word, Excel, PowerPoint, or Outlook - you work in the chat window and copy results into your documents.',
            'Image generation is capped at a small number per day.',
          ],
        },
        right: {
          title: 'Copilot Pro ($20/month)',
          items: [
            'Priority access to the more capable models even during peak usage times, so you are less likely to get downgraded.',
            'Copilot becomes available directly inside Microsoft 365 desktop apps rather than only the standalone web chat.',
            'A larger daily allowance for image generation.',
            'Still has rough edges: the reviewer ran into bugs and file-location limitations using Copilot inside Excel and PowerPoint.',
          ],
        },
      },
      {
        ...
        heading: 'Key ideas from the video',
        items: [
          { title: 'The core value proposition', body: 'Paying for Pro mainly buys priority speed/quality at peak times and the ability to use Copilot from inside Office apps instead of a separate chat window.' },
          { title: 'For pure chatbot use, the gap is small', body: 'For everyday Q&A-style prompting, the reviewer found free Copilot produced results close enough to Pro that the difference was hard to justify on its own.' },
          { title: 'In-app integration is not flawless', body: 'Testing Copilot inside Word, Excel, and PowerPoint surfaced bugs, restrictive file-location requirements, and irrelevant auto-inserted content - features being "unlocked" does not mean they are polished.' },
          { title: 'Decide based on your own workflow', body: 'The upgrade pays off fastest for people who live inside Office apps daily and would genuinely use in-app Copilot, not for casual or occasional users.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'According to the video, what is the main practical difference between Copilot Free and Copilot Pro?',
        options: ['Pro can access the internet and Free cannot', 'Pro adds priority access to faster/better models plus in-app integration with Office apps', 'Free is only available on mobile devices', 'Pro removes all usage limits entirely'],
        answer: 1,
        explanation: 'The reviewer highlights priority model access and Office-app integration as the two things Pro actually adds.',
      },
      {
        prompt: 'For basic chatbot-style questions, how did the reviewer say Free Copilot compared to Pro?',
        options: ['Free was noticeably worse in every test', 'The results were close enough that the difference was hard to justify', 'Free refused to answer most questions', 'Pro was unable to answer general questions'],
        answer: 1,
        explanation: 'For everyday chat use, the reviewer found the free tier produced comparable results to Pro.',
      },
      {
        prompt: 'What issue did the reviewer run into when testing Copilot inside Microsoft 365 apps?',
        options: ['It worked perfectly with zero issues', 'Bugs, file-location restrictions, and irrelevant inserted content', 'It refused to open in Excel or PowerPoint at all', 'It required a separate Microsoft 365 subscription to even launch'],
        answer: 1,
        explanation: 'The in-app experience had rough edges, including bugs in Excel and PowerPoint and file-location limitations.',
      },
      {
        prompt: 'Who benefits most from upgrading to Copilot Pro, based on the video?',
        options: ['Someone who never uses Microsoft Office apps', 'Someone who works inside Word, Excel, and PowerPoint daily and wants Copilot embedded there', 'Someone who only wants image generation', 'Someone who wants unlimited free access to Copilot forever'],
        answer: 1,
        explanation: 'Heavy daily users of Office apps get the most value from in-app integration and priority access.',
      },
    ],
  },
  {
    id: 'productivity-14',
    partLabel: 'Part 14 of 17',
    part: 14,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Job descriptions, policy drafts, and meeting agendas all follow predictable structures - which makes them exactly the kind of writing Copilot and Claude are good at drafting quickly. The trick is not a magic one-line prompt; it is giving the AI enough structure up front and revising in stages.',
        body: 'This video demonstrates that workflow inside Copilot for Word - the same technique applies whether you are drafting a job posting, a policy document, or a meeting agenda in Copilot or Claude.',
      },
      {
        kind: 'video',
        youtubeId: '1Ln4ypWgHME',
        heading: 'Watch: How to Draft Documents with Copilot in Microsoft Word (~8 min)',
        caption: 'Erin Wright Writing (~8 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'Front-load your prompt with structure', body: 'A strong starting prompt names the document type, the audience, the tone, an approximate length, and any sections you need - the more specific the request, the more usable the first draft.' },
          { title: 'You can point it at reference material', body: "You can attach or reference existing files (a style guide, a past policy, prior meeting notes) so the draft matches your organization's existing tone and format instead of generic filler." },
          { title: 'Revise in stages, not all at once', body: 'Fix structure first - add or reorder sections, insert a summary - before asking for tone or wording changes. Trying to fix everything in one prompt produces messier results.' },
          { title: 'Always review manually before using it', body: "The draft is a starting point, not a finished product - check it for accuracy and edit it so it reflects your own voice and your organization's actual policies before sending or publishing." },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What should you include in your initial prompt for the best first draft, according to the video?',
        options: ['Nothing - a one-word prompt works best', 'Document type, audience, tone, approximate length, and required sections', 'Only the document title', 'The exact final wording you want'],
        answer: 1,
        explanation: 'A detailed prompt covering type, audience, tone, length, and sections produces a far more usable first draft than a vague request.',
      },
      {
        prompt: "How can you make a drafted document match your organization's existing style?",
        options: ['You cannot - every draft uses generic Copilot phrasing', 'By referencing or attaching an existing file as a style/format example', 'By only using bullet points', 'By writing the whole document yourself first'],
        answer: 1,
        explanation: 'Copilot in Word lets you point to a source file so the draft follows an established tone or format.',
      },
      {
        prompt: 'What revision order does the video recommend?',
        options: ['Fix tone and wording first, then worry about structure', 'Fix structure first, then refine tone and readability', 'Only ever ask for one giant revision at the end', 'Revise randomly in any order'],
        answer: 1,
        explanation: 'The staged approach is structural changes first, then tone/readability, since fixing everything in one pass produces messier output.',
      },
      {
        prompt: 'What is the final, essential step before using an AI-drafted business document?',
        options: ['Publishing it immediately since AI drafts are always accurate', 'Manually reviewing it for accuracy and adjusting it to match your own voice', 'Deleting the original prompt', 'Asking a second AI tool to approve it'],
        answer: 1,
        explanation: 'The video stresses reviewing the draft manually for accuracy - AI output is a starting point, not a final answer.',
      },
    ],
  },
  {
    id: 'productivity-15',
    partLabel: 'Part 15 of 17',
    part: 15,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'You do not need to be an Excel formula expert to get insight out of a spreadsheet anymore. Copilot in Excel lets you ask questions about your data in plain English and get back summaries, trends, and charts.',
        body: 'This walkthrough covers how to actually use that feature on a real spreadsheet, from entering data through generating insights and visuals.',
      },
      {
        kind: 'video',
        youtubeId: 'z8L2w5utx-M',
        heading: 'Watch: How to Use Copilot in Excel: Full Tutorial (~14 min)',
        caption: 'Lisa Crosbie (~14 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'Your data needs to be a proper Excel Table', body: 'Copilot in Excel works on data that has been formatted as a Table (not just a loose range of cells) - that structure is what lets it understand your columns and rows.' },
          { title: 'Ask questions in plain language', body: 'Instead of writing a formula yourself, you can type a question like "what are the trends in this data?" or "which region had the biggest change?" and Copilot interprets it against your table.' },
          { title: 'It can suggest formulas, not just answer questions', body: 'Copilot can generate formula suggestions for a column based on what you describe wanting to calculate, rather than you writing the formula syntax from scratch.' },
          { title: 'Insights come back as charts, PivotTables, and summaries', body: 'Rather than a wall of text, Copilot can surface trends and outliers visually - as a chart or PivotTable - so you can see the pattern, not just read about it.' },
          { title: 'Verify before you rely on it', body: 'As with any AI-generated formula or summary, check the output against the source data - it is a fast first pass, not a guaranteed-correct final answer.' },
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What does your data need to be formatted as before Copilot in Excel can analyze it well?',
        options: ['A PDF export', 'A proper Excel Table', 'A single merged cell', 'A PowerPoint slide'],
        answer: 1,
        explanation: 'Copilot in Excel relies on your data being structured as a Table so it can understand the columns and rows.',
      },
      {
        prompt: 'How do you ask Copilot in Excel to find a trend, according to the video?',
        options: ['You must write a PivotTable formula manually first', 'You can type a plain-language question about the data', 'You have to export the data to another program', 'You cannot ask about trends, only totals'],
        answer: 1,
        explanation: 'The whole point of the feature is asking in natural language rather than writing formulas or PivotTables yourself.',
      },
      {
        prompt: 'Besides answering questions, what else can Copilot in Excel help generate?',
        options: ['New Excel files with no data', 'Formula suggestions for a column based on a plain-language description', 'Physical printouts of your spreadsheet', 'Video summaries of your data'],
        answer: 1,
        explanation: 'Copilot can suggest formulas for you based on what you describe wanting to calculate.',
      },
      {
        prompt: 'What should you do with an AI-suggested formula or insight before relying on it for a business decision?',
        options: ['Trust it completely with no review', 'Verify it against the source data', 'Delete the original data', 'Ignore it entirely'],
        answer: 1,
        explanation: 'The video treats AI output as a fast first pass that still needs to be checked against the actual data.',
      },
    ],
  },
  {
    id: 'productivity-16',
    partLabel: 'Part 16 of 17',
    part: 16,
    ...
    sections: [
      {
        kind: 'lead',
        text: 'Nobody enjoys turning a pile of scattered notes into a polished status report.',
        body: 'Weekly updates, project summaries, and stakeholder recaps eat up real time - and most of that time is spent formatting and rephrasing, not thinking. Copilot and Claude are well-suited to this exact job: hand over your raw notes and a description of what you need, and get back a structured first draft you can review and send.',
      },
      {
        kind: 'video',
        youtubeId: 'kMfl82kQ4t4',
        heading: 'Watch: How I Use Copilot to Automate Reports in Minutes (~10 min)',
        caption: 'Prof. Ryan Ahmed (~10 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: 'Start from what you already have', body: "You don't need perfectly organized input - bullet points, meeting notes, or rough updates are enough for Copilot to work from." },
          { title: 'Tell it the shape of the output you want', body: 'Naming the sections, headings, or format you expect (executive summary, status by workstream, next steps) is what turns generic text into a usable report.' },
          { title: 'Iterate instead of starting over', body: 'If the first draft is too long, too short, or the wrong tone, ask Copilot to adjust it rather than rewriting from scratch.' },
          { title: 'The draft is a starting point, not the final product', body: 'You still need to check that facts, numbers, and names in the generated report are correct before sending it.' },
        ],
      },
      {
        kind: 'checklist',
        heading: 'Before you send an AI-drafted report, check…',
        items: [
          'Did you give it your actual notes and a clear sense of the audience?',
          'Did you specify the sections or format you wanted back?',
          'Have you verified every number, name, and date in the draft?',
          'Does the tone match how you would normally write to this audience?',
        ],
      },
    ],
    quiz: [
      {
        prompt: 'What is the main benefit of using Copilot to draft a status report from your notes?',
        options: ['It replaces the need to know what happened on the project', 'It turns scattered notes into a structured first draft quickly, saving formatting time', 'It automatically emails the report to your manager', 'It only works if your notes are already perfectly organized'],
        answer: 1,
        explanation: 'The value is speed on the drafting and formatting work - you still supply the substance and judgment.',
      },
      {
        prompt: 'What should you give Copilot before asking it to generate a report?',
        options: ['Nothing - it will guess what you want', 'Your raw notes plus a description of the format or sections you want back', 'A finished report to copy', 'Your login credentials for the project tracker'],
        answer: 1,
        explanation: 'Providing your notes and the desired structure is what lets Copilot produce something close to usable on the first try.',
      },
      {
        prompt: 'If the first draft of a report is the wrong length or tone, what is the better next step?',
        options: ['Start over from a blank page', 'Ask Copilot to adjust the existing draft', 'Give up on using AI for this task', 'Send it anyway'],
        answer: 1,
        explanation: 'Iterating on the draft with follow-up instructions is faster than starting from scratch.',
      },
      {
        prompt: 'Before sending an AI-generated status report, what must you still do?',
        options: ['Nothing, it is ready to send', 'Verify the facts, numbers, and names in the draft', 'Translate it into another language', 'Delete your original notes'],
        answer: 1,
        explanation: 'AI can phrase things confidently even when a detail is off, so a human check before sending is essential.',
      },
    ],
  },
  {
    id: 'productivity-17',
    partLabel: 'Part 17 of 17',
    part: 17,
    title: 'When Not to Trust AI Output Blindly',
    tagline: 'AI can sound completely confident while being completely wrong - know when to double-check.',
    requirement: 'required',
    minutes: 8,
    sections: [
      {
        kind: 'lead',
        text: 'AI tools are genuinely useful for work, but they are not always right - and they rarely sound unsure when they are wrong.',
        body: 'Copilot and Claude generate text by predicting what is likely to come next, not by looking facts up in a verified database. That means confident-sounding answers on numbers, legal questions, or compliance details can still be completely fabricated. Knowing when to slow down and verify is as important as knowing how to prompt.',
      },
      {
        kind: 'video',
        youtubeId: 'cfqtFvWOfg0',
        heading: 'Watch: Why Large Language Models Hallucinate (~8 min)',
        caption: 'IBM Technology (~8 min)',
      },
      {
        kind: 'list',
        heading: 'Key ideas from the video',
        items: [
          { title: "AI predicts, it doesn't retrieve", body: 'Large language models generate answers by predicting statistically likely next words based on patterns in training data - not by pulling verified facts from a database.' },
          { title: 'A hallucination is confident, fluent, and wrong', body: "The danger isn't that AI sounds unsure when it's wrong - it's that fabricated answers can look just as polished and authoritative as correct ones." },
          { title: 'This is a byproduct of how the technology works, not just a bug', body: "Hallucination is inherent to how current LLMs generate text, so it can be reduced but isn't something that gets fully \"fixed\" with an update." },
          { title: 'Clearer prompts and grounding reduce - not eliminate - the risk', body: 'Giving specific context, and techniques like retrieval-augmented generation (RAG) that ground answers in real source documents, meaningfully cut down on fabricated answers.' },
        ],
      },
      {
        kind: 'checklist',
        heading: 'Red flags - verify before you rely on it',
        items: [
          'Any specific number, statistic, date, or calculation',
          'Any legal, regulatory, or compliance claim',
          'Any citation, quote, or source the AI attributes to someone',
          'Anything that will go into a contract, filing, or decision with real consequences',
        ],
      },
    ],
    quiz: [
      {
        prompt: 'According to the video, how do large language models actually generate their answers?',
        options: ['By looking up facts in a verified internal database', 'By predicting statistically likely next words based on patterns in training data', 'By calling a search engine every time', 'By asking a human reviewer to confirm each answer'],
        answer: 1,
        explanation: 'LLMs are prediction engines, not fact-retrieval systems - that distinction is the root cause of hallucination.',
      },
      {
        prompt: 'What makes an AI hallucination particularly risky for business use?',
        options: ['It always comes with a warning label', "It is delivered in a hesitant, unsure tone so it's easy to catch", 'It can sound just as confident and polished as a correct answer', 'It only happens with free versions of AI tools'],
        answer: 2,
        explanation: "The video stresses that fabricated content is not obviously 'off' - it can look just as authoritative as accurate content.",
      },
      {
        prompt: "Why can't hallucinations be completely eliminated with the current generation of LLMs?",
        options: ['Because companies refuse to fix the problem', 'Because it is inherent to how these models predict and generate text, not just a fixable software bug', 'Because hallucinations only happen on outdated models', 'Because users type too fast'],
        answer: 1,
        explanation: 'Hallucination stems from the underlying prediction-based architecture, so it can be reduced but not fully removed.',
      },
      {
        prompt: 'What technique does the video mention for grounding AI answers in real source material?',
        options: ['Retrieval-augmented generation (RAG)', 'Turning off autocomplete', 'Using a louder microphone for voice prompts', 'Switching to airplane mode'],
        answer: 0,
        explanation: "RAG connects a model's answers to actual retrieved documents, which helps reduce fabricated details.",
      },
    ],
  },
];
...
export const TRACKS: Track[] = [
  ...
  },
  {
    ...
    subtitle:
      'Seventeen videos on getting real work done with Claude Pro and Microsoft Copilot - with a quiz after each.',
    accent: '#2563eb',
    accentSoft: '#eff6ff',
